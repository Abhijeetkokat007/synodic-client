...
function TeamCard() {
  return (
    ...
    <h1 className='text-white text-[40px] text-center font-bold p-5'>Our Team</h1>
    <div className=' flex justify-center items-center'>
       
       <div className="text-center text-white  shadow-2xl w-[300px] p-[20px]  rounded-lg card-container m-3">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://images.ctfassets.net/h6goo9gw1hh6/2sNZtFAWOdP1lmQ33VwRN3/24e953b920a9cd0ff2e1d587742a2472/1-intro-photo-final.jpg?w=1200&h=992&fl=progressive&q=70&fm=jpg" alt="Michael Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-white ">
                  <a href="#">John Deo</a>
              </h3>
              <p>Instructor</p>
              <p className='text-gray-1'>DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
